      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          ...
          <div class="pull-left info">
            ...
            <!-- Status -->
            <a href=""><i class="fa fa-circle text-success"></i> Docente Activo </a>
          </div>
        </div>
        <br><br>
        <!-- Sidebar Menu -->
        <ul class="sidebar-menu" data-widget="tree">
          ...
          @yield('activeInformacion')<a href="{{route('DocenteInformacion')}}"><i class="fa fa-drivers-license-o"></i> <span>Información Personal</span></a></li>
          ...
          <ul class="treeview-menu">
            @yield('activeTomaLista')<a href="{{route('TomarListaDocente')}}">Tomar Lista</a></li>
            @yield('activeAsistenciaPorFecha')<a href="{{route('AsistenciaFechaDeterminada')}}">Asistencia por día</a></li>
            @yield('activeAsistenciaRangoFechas')<a  href="{{route('AsistenciaEntreFechas')}}">Asistencia entre fechas</a></li>
            @yield('activePorcentajeAsistencia')<a href="{{route('PorcentajesDeAsistenciaDocente')}}">Porcentaje de asistencia</a></li>
          </ul>
          </li>
