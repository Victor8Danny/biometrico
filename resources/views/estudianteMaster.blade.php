      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          ...
          <div class="pull-left info">
            ...
            <!-- Status -->
            <a href=""><i class="fa fa-circle text-success"></i> Estudiante Activo </a>
          </div>
        </div>
        <br><br>
        <!-- Sidebar Menu -->
        <ul class="sidebar-menu" data-widget="tree">
          ...
          @yield('activeInformacion')<a href="{{route('EstudianteInformacion')}}"><i class="fa fa-drivers-license-o"></i> <span>Información Personal</span></a></li>
          @yield('activeMenuAsistencias')
          ...
          <ul class="treeview-menu">
            ...
            @yield('activeAsistenciaPorFecha')<a href="{{route('AsistenciaFechaDeterminadaEstudiante')}}">Asistencia por día</a></li>
            @yield('activeAsistenciaRangoFechas')<a  href="{{route('AsistenciaEntreFechasEstudiante')}}">Asistencia entre fechas</a></li>
            @yield('activeAsistenciasPorModulo')<a href="{{route('MostrarPorcentajeAsistenciaEstudiante')}}">Porcentajes de asistencia</a></li>
          </ul>
          </li>
          @yield('activeMenuHorarios')
          ...
          <ul class="treeview-menu">
            @yield('activeListaHorario')<a href="{{route('ListaHorarioEstudiante')}}">Lista de horarios</a></li>
